...
Read [architecture](docs/ARCHITECTURE.md), [mission](docs/MISSION.md), [autonomy policy](docs/AUTONOMY_POLICY.md), [SEO policy](docs/SEO_POLICY.md), [threat model](docs/THREAT_MODEL.md), [blind evaluation protocol](docs/BLIND_EVALUATION_PROTOCOL.md), [agent contracts](docs/AGENT_CONTRACTS.md), [data model](docs/DATA_MODEL.md), [runbook](docs/RUNBOOK.md), [failure modes](docs/FAILURE_MODES.md), and [current mission state](docs/MISSION_STATE.json).
